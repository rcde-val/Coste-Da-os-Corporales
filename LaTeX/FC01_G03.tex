...
\section{Análisis metodológico escogido}
    El objetivo inicial es comprender la estructura del conjunto de datos y familiarizarnos con las variables disponibles, ya que esto constituye la base para cualquier análisis exploratorio. En la Tabla 01 se presenta una descripción resumida de las variables correspondientes a una cartera de una aseguradora en Francia, que incluyen características del vehículo, del conductor, de la póliza y los montos asociados a los reclamos, entre otros.
    ...
    \midrule
    IDpol & Número de póliza. \\
    ClaimNb & Número de reclamos realizados durante el período de exposición. \\
    Exposure & Tiempo que la póliza estuvo vigente y expuesta al riesgo, en años. \\
    VehPower & Potencia del coche (valores ordenados en orden ascendente, de d a o). \\
    VehAge & Antigüedad del vehículo, en años. \\
    DrivAge & Edad del conductor, en años. \\
    BonusMalus & Sistema Bonus/Malus: $<100$ = bonificación, $>100$ = penalización. \\
    VehBrand & Marca del vehículo. \\
    VehGas & Tipo de combustible: Diesel o Regular. \\
    Density & Número de habitantes por km² en la ciudad del conductor. \\
    Region & Región de la póliza en Francia. \\
    ClaimAmount & Costo total del reclamo. \\
    InjuryAmount & Costo de compensación por lesiones corporales. \\
    PropertyAmount & Costo por daños a la propiedad. \\
    \bottomrule
    \end{tabularx}
    \end{table}
