...
\hypertarget{Volver23}{} 
        	(1,1) a los verdaderos positivos. En el \textcolor{blue}{\hyperlink{Cuadro14}{(Cuadro 14)}} se muestran los resultados. \\
...
\hypertarget{Volver26}{} 
        	...
        	\paragraph{Modelización paramétrica}
				...
				\begin{table}[H]
					\centering
					\begin{threeparttable}
						\caption{Modelización paramétrica}
						\begin{tabular}{lrrrr}
							\toprule
							\textbf{Distribución} & \textbf{$VaR_{99,0\%}$} & \textbf{$VaR_{99,5\%}$} & \textbf{$VaR_{99,\%}$} & \textbf{AI}C \\
							\midrule
								Weibull & 49 & 114 & 151 & 94.128 \\
								Gamma & 70 & 131 & 159 & 99.511 \\
								Log-Normal & 80 & 365 & 637 & 94.767 \\
								Log-Logística & 94 & 723 & 1.712 & 64.499 \\
			...
			\paragraph{Distribuciones multivariadas}
				...
				% Modelización seleccionada y objetivos a alcanzar: Costo del siniestro - Distribuciones multivariadas
					\begin{table}[H]
						...
						\begin{tabular}{lcc}
							\toprule
							\textbf{Distribución} & \textbf{AIC escala original (sim.)} & \textbf{AIC escala original (asim.)} \\
							\midrule
